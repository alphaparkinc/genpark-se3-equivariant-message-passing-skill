# genpark-se3-equivariant-message-passing-skill

[![Agentic Skill](https://img.shields.io/badge/GenPark-Agentic__Skill-blue.svg)](https://github.com/alphaparkinc/genpark-se3-equivariant-message-passing-skill)
...
> SE(3) and E(n) equivariant graph neural network message passing kernel preserving exact 3D rotational and translational symmetries in molecular and physical systems.
...
flowchart TD
    ...
    B --> C[genpark-se3-equivariant-message-passing-skill Kernel]
